...
class GroupController extends Controller {
    ...
    public function actionEdit() {
        ...
        $viewData['formTitle'] = Yii::t(
                        'main', empty($group_id) ? 'Create Group' : 'Edit Group'
        );
        $model = empty($group_id) ? new UserGroup() : UserGroup::model()->currentCompany()->with(
                        array(
                            'users' => array(
        ...
        $viewData['form'] = $form;
        $viewData['formAction'] = empty($model->group_id) ? $this->createUrl('group/create') : $this->createUrl(
                        'group/edit', array('group_id' => $model->group_id)
        );

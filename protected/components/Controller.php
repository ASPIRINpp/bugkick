...
class Controller extends CController {
    ...
    public function getProjectsDropDown($htmlOptions) {
        ...
        $projects = Yii::app()->db->createCommand($sql)->queryAll(
                true, array(':user_id' => Yii::app()->user->id)
        );
        ...
        return CHtml::dropDownList(
                        'menu_project_id', empty($selectedProject) ? null : $selectedProject->project_id, $data, array_merge(array('style' => 'margin:0 5px 0 5px;'), $htmlOptions)
        );
    }
